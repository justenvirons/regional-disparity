...
# Study areas
We examine patterns of chronic disease prevalence across two study areas; one multi-county and regional and the other confined to CCDPH's jurisdiction within Cook County. The regional, multiple county analysis examines broader public health patterns across eight Chicago metropolitan counties: Cook, DuPage, Kane, Kendall, Lake (IL), McHenry and Will in Illinois and Lake (IN) county in northwestern Indiana. Collectively, these counties span an area of 4,573 square miles (11,845 square kilometers) and have a combined residential population of 8.9 million (2019). These counties were selected in part because they represent considerable diversity both in terms of urban design (e.g., including high-density urban and lower-density exurban communities) and sociodemographic makeup. Seven of the eight counties in the study area also correspond with the Chicago Metropolitan Agency for Planning's (CMAP) planning area thereby easing integration of CMAP data and presenting opportunities for future research to be carried across CMAP's jurisdiction. Lake County, Indiana was also added to the regional study area because of its well known public health challenges and because it shares a boundary with CCDPH's southernmost extent. An interactive map of the regional study area is provided in Figure 1. Hover over each of the counties for additional county-specific information.
...
Centers for Disease Control and Prevention (CDC) PLACES dataset was used to model chronic disease across the study areas at the census tract level.

## ACS 5-year sociodemographic estimates (link)
The US Census Bureau's 5-year estimates are also used to. For this analysis we examine...tables...age characteristics (for denominators)...below poverty.
